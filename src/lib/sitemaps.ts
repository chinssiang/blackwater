...
export const SYNTHETIC_ROUTES: ReadonlyArray<{
...
}> = [
	{
		...
		sitemap: 'products',
		// pBrand: the page's filter facets select brand documents by name and
		// render their titles, so renaming a brand changes what this page shows.
		lists: ['pProduct', 'pProductCategory', 'pBrand'],
	},
	{
